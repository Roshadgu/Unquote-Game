...
public class MainActivity extends AppCompatActivity
{
    ...
    ImageView questionImageV;

    TextView questionTextV;
    TextView questionsRemainingV;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        questionImageV = findViewById(R.id.iv_main_question_image);
        questionTextV = findViewById(R.id.tv_main_question_title);
        questionsRemainingV = findViewById(R.id.tv_main_questions_remaining_count);
    ...
    {
        questionTextV.setText(question.questionText);
        questionImageV.setImageResource(question.imageId);
    ...
    {
        String qR = Integer.toString(questionRemaining);
        questionsRemainingV.setText(qR);
    }
    ...
    void onAnswerSubmission()
    {
        ...
        {
            AlertDialog.Builder submitError = new AlertDialog.Builder(MainActivity.this);
            submitError.setCancelable(true);
            submitError.setTitle("No Answer Selected");
            submitError.setMessage("Before submitting please select an answer to submit");

            submitError.create().show();
        }
        ...
        else
        {
            ...
            if (questions.size() == 0)
            {
                ...
                gameOverDialogBuilder.setTitle("Gamer Over!");
                gameOverDialogBuilder.setMessage("The game is over. Do you want to try again?");
    ...
    void startNewGame()
    {
        ...
        Question question3 = new Question(R.drawable.img_quote_3, "Insanely inspiring,insanely incorrect(maybe). Who is the true source of this inspiration?", "Nelson Mandela", "Harriet Tubman", "Mahatma Gandh", "Nicholas Klein", 3);
